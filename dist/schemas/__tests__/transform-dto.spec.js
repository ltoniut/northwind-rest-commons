...
const transform_dto_1 = __importDefault(require("schemas/transform-dto"));
...
function testTransform(src, opts) {
    const dst = transform_dto_1.default.transformDto(src, opts);
...
describe('Transform DTO', () => {
    it('Should copy Foo', () => {
        const dst = testTransform(Object.assign({}, foo1));
    ...
    it('Should copy Bar', () => {
        const dst = testTransform(Object.assign(Object.assign({}, bar1), { owner: Object.assign({}, foo1) }));
        expect(dst).toBeDefined();
        expect(dst).toHaveProperty('_type');
        expect(dst).not.toHaveProperty('_meta');
        expect(dst).toHaveProperty('id');
    ...
    it('Should copy Bar with meta and a mix includes and excludes', () => {
        const dst = testTransform(Object.assign(Object.assign({}, bar1), { _meta: {
                reqId: 12,
                usrId: 'adminMaster',
            }, owner: Object.assign({}, foo1) }), {
...
//# sourceMappingURL=transform-dto.spec.js.map